...
export default function MultiDeviceSync({ className }: Props) {
  return (
    ...
    >
      ...
      <rect x="40" y="80" width="28" height="4" rx="2" fill="white" stroke="#111" strokeWidth="1"/>
      <rect x="40" y="88" width="22" height="4" rx="2" fill="white" stroke="#111" strokeWidth="1"/>
      <rect x="40" y="96" width="25" height="4" rx="2" fill="white" stroke="#111" strokeWidth="1"/>
      <rect x="40" y="104" width="20" height="4" rx="2" fill="white" stroke="#111" strokeWidth="1"/>
      <rect x="40" y="112" width="24" height="4" rx="2" fill="white" stroke="#111" strokeWidth="1"/>
      {/* main content panel */}
      ...
      <rect x="86" y="128" width="60" height="10" rx="3" fill="white" stroke="#111" strokeWidth="1.5"/>
      {/* table row */}
      ...
      {/* Checkmark (blue spot colour) */}
      <circle cx="220" cy="157" r="6" fill="white" stroke="#111" strokeWidth="1.5"/>
      <polyline points="217,157 219,160 224,154" stroke={BLUE} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      ...
      <rect x="280" y="100" width="18" height="4" rx="2" fill="white" stroke="#111" strokeWidth="0.8"/>
      <rect x="280" y="108" width="14" height="4" rx="2" fill="white" stroke="#111" strokeWidth="0.8"/>
      <rect x="280" y="116" width="16" height="4" rx="2" fill="white" stroke="#111" strokeWidth="0.8"/>
      <rect x="280" y="124" width="12" height="4" rx="2" fill="white" stroke="#111" strokeWidth="0.8"/>
      {/* tablet content */}
      ...
      <rect x="312" y="122" width="44" height="6" rx="2" fill="white" stroke="#111" strokeWidth="1.5"/>
      {/* tablet table */}
      ...
      <rect x="282" y="177" width="40" height="8" rx="2" fill="white" stroke="#111" strokeWidth="1.5"/>
      {/* tablet checkmark (blue spot colour) */}
      ...
      <circle cx="376" cy="217" r="5" fill="white" stroke="#111" strokeWidth="1.5"/>
      <polyline points="373.5,217 375.5,219.5 379,214.5" stroke={BLUE} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      ...
      <rect x="420" y="126" width="40" height="5" rx="2" fill="white" stroke="#111" strokeWidth="1"/>
      ...
      {/* phone checkmark (blue spot colour) */}
