...
export default function MultiDeviceSync({ className }: Props) {
  return (
    ...
    >
      <rect x="20" y="40" width="220" height="150" rx="10" fill="white" stroke="#111" strokeWidth="2.5"/>
      <rect x="20" y="40" width="220" height="24" rx="10" fill="white" stroke="#111" strokeWidth="2.5"/>
      <rect x="20" y="52" width="220" height="12" fill="white"/>
      <circle cx="34" cy="52" r="4" fill="#e5e7eb"/>
      <circle cx="48" cy="52" r="4" fill="#e5e7eb"/>
      <circle cx="62" cy="52" r="4" fill="#e5e7eb"/>
      <line x1="110" y1="190" x2="130" y2="205" stroke="#111" strokeWidth="2.5"/>
      <rect x="100" y="205" width="60" height="6" rx="3" fill="#111"/>
      ...
      <rect x="40" y="96" width="28" height="4" rx="2" fill="#e5e7eb"/>
      <rect x="40" y="104" width="22" height="4" rx="2" fill="#e5e7eb"/>
      <rect x="40" y="112" width="25" height="4" rx="2" fill="#e5e7eb"/>
      <rect x="40" y="120" width="20" height="4" rx="2" fill="#e5e7eb"/>
      <rect x="86" y="76" width="140" height="60" rx="4" fill="white" stroke="#111" strokeWidth="1.5"/>
      <rect x="86" y="76" width="140" height="14" rx="4" fill="white" stroke="#111" strokeWidth="1.5"/>
      <rect x="86" y="76" width="140" height="7" fill="white"/>
      <rect x="90" y="79" width="30" height="7" rx="2" fill="#f3f4f6"/>
      <rect x="125" y="79" width="30" height="7" rx="2" fill="#f3f4f6"/>
      <rect x="86" y="96" width="140" height="4" rx="2" fill="#f3f4f6"/>
      <rect x="86" y="104" width="100" height="4" rx="2" fill="#f3f4f6"/>
      <rect x="86" y="112" width="120" height="4" rx="2" fill="#f3f4f6"/>
      <rect x="86" y="120" width="80" height="4" rx="2" fill="#f3f4f6"/>
      ...
      <rect x="40" y="154" width="50" height="6" rx="2" fill="#f3f4f6"/>
      <rect x="98" y="154" width="50" height="6" rx="2" fill="#f3f4f6"/>
      <rect x="156" y="154" width="40" height="6" rx="2" fill="#f3f4f6"/>
      ...
      <rect x="278" y="75" width="50" height="6" rx="3" fill="#f3f4f6"/>
      ...
      <rect x="280" y="110" width="18" height="3" rx="1.5" fill="#e5e7eb"/>
      <rect x="280" y="116" width="14" height="3" rx="1.5" fill="#e5e7eb"/>
      <rect x="280" y="122" width="16" height="3" rx="1.5" fill="#e5e7eb"/>
      <rect x="308" y="96" width="72" height="40" rx="4" fill="white" stroke="#111" strokeWidth="1.5"/>
      <rect x="308" y="96" width="72" height="9" rx="4" fill="white" stroke="#111" strokeWidth="1.5"/>
      <rect x="308" y="100" width="72" height="5" fill="white"/>
      <rect x="312" y="110" width="64" height="3" rx="1.5" fill="#f3f4f6"/>
      <rect x="312" y="116" width="50" height="3" rx="1.5" fill="#f3f4f6"/>
      ...
      <rect x="282" y="152" width="96" height="3" rx="1.5" fill="#f3f4f6"/>
      <rect x="282" y="158" width="60" height="3" rx="1.5" fill="#f3f4f6"/>
      <rect x="282" y="164" width="80" height="3" rx="1.5" fill="#f3f4f6"/>
      <rect x="282" y="170" width="50" height="3" rx="1.5" fill="#f3f4f6"/>
      ...
      <rect x="286" y="215" width="40" height="5" rx="2" fill="#f3f4f6"/>
      <rect x="334" y="215" width="30" height="5" rx="2" fill="#f3f4f6"/>
      ...
      <rect x="422" y="104" width="20" height="4" rx="2" fill="#f3f4f6"/>
      ...
      <rect x="420" y="135" width="40" height="3" rx="1.5" fill="#f3f4f6"/>
      <rect x="420" y="141" width="30" height="3" rx="1.5" fill="#f3f4f6"/>
      <rect x="418" y="162" width="44" height="14" rx="3" fill="white" stroke="#111" strokeWidth="1.5"/>
      <rect x="421" y="166" width="22" height="3" rx="1.5" fill="#f3f4f6"/>
