...
export default function InvoicePreview({ className }: Props) {
  return (
    ...
    >
      ...
      <rect x="82" y="40" width="30" height="5" rx="2" fill="white" stroke="#111" strokeWidth="1"/>
      <rect x="82" y="48" width="40" height="4" rx="2" fill="white" stroke="#111" strokeWidth="1"/>
      {/* Client info box */}
      <rect x="168" y="28" width="64" height="22" rx="4" fill="white" stroke="#111" strokeWidth="1.5"/>
      <rect x="172" y="32" width="30" height="4" rx="2" fill="white" stroke="#111" strokeWidth="1"/>
      <rect x="172" y="38" width="50" height="4" rx="2" fill="white" stroke="#111" strokeWidth="1"/>
      <rect x="172" y="44" width="40" height="4" rx="2" fill="white" stroke="#111" strokeWidth="1"/>
      {/* To / address block */}
      <rect x="48" y="76" width="80" height="6" rx="2" fill="#111"/>
      <rect x="48" y="86" width="100" height="4" rx="2" fill="white" stroke="#111" strokeWidth="1"/>
      ...
      <rect x="212" y="137" width="16" height="4" rx="2" fill="white" stroke="#111" strokeWidth="1"/>
      <rect x="48" y="146" width="80" height="4" rx="2" fill="white" stroke="#111" strokeWidth="1"/>
      <rect x="170" y="146" width="24" height="4" rx="2" fill="white" stroke="#111" strokeWidth="1"/>
      <rect x="212" y="146" width="16" height="4" rx="2" fill="white" stroke="#111" strokeWidth="1"/>
      <rect x="48" y="155" width="90" height="4" rx="2" fill="white" stroke="#111" strokeWidth="1"/>
      <rect x="170" y="155" width="24" height="4" rx="2" fill="white" stroke="#111" strokeWidth="1"/>
      <rect x="212" y="155" width="16" height="4" rx="2" fill="white" stroke="#111" strokeWidth="1"/>
      <rect x="48" y="164" width="60" height="4" rx="2" fill="white" stroke="#111" strokeWidth="1"/>
      ...
      <rect x="276" y="88" width="76" height="4" rx="2" fill="white" stroke="#111" strokeWidth="1" opacity="0.8"/>
